...
import { getFirestore, collection, getDocs, deleteDoc, updateDoc, deleteField } from 'https://www.gstatic.com/firebasejs/10.12.4/firebase-firestore.js';
...
del.addEventListener("click", function(e){
    ...
    async function del1() {
        ...
        querySnap.forEach((dox)=> {
            ...
            deleteDoc(dox.ref).then(() =>{
            }).catch((error) => {
                console.error(`Error deleting document: ${doc.id}`, error);
            });
        });
    }
    var prot = prompt("Enter secret code");
    if(prot == "delete complete attendance"){
        del1();
    }else{
